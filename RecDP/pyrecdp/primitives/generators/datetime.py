...
class DatetimeFeatureGenerator(FeaturetoolsBasedFeatureGenerator):
    ...
    def fit_prepare(self, pipeline, children, max_idx):
        ...
        feature_in = {
            pa_field.name: [self.op_list[i] for i in pa_field.datetime_ft_list]
        ...
        for in_feat_name in feature_in:
            ...
            feature_in_out_map[in_feat_name] = [(out_feat_name, DatetimeTransformer)]
        ...
        is_useful = False
        for in_feat_name, value in feature_in_for_ops.items():
            is_useful = True
